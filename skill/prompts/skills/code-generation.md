...
This skill fragment provides guidelines for generating idiomatic, production-quality code. Apply these guidelines whenever writing code snippets or implementation instructions.

---

## Match Existing Conventions

Before writing any code, check `platform.yaml` for detected conventions. Then:
...
When producing code snippets in a plan:
