...
2. Deployment uses GitHub Pages in Actions-artifact mode: `configure-pages` +
   ...
   Published URL: `https://vitualizz.github.io/ai-software-delivery-team/`.
...
4. `astro.config.mjs` sets `base: '/ai-software-delivery-team/'`. All internal
...
- `base: '/ai-software-delivery-team/'` must be set in every internal href; removing
