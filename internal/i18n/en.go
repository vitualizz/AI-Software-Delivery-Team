...
var English = Catalog{
	Installer: InstallerStrings{
		...
		OptionModelsRecommended:    "Use recommended models — each step ships with a sensible default",
		OptionModelsCustomize:      "Customize per step — choose the model for each specialist step",
		HintRunsAs:                 "→ runs as %s on Claude Code",
		LabelModels:                "Models:",
		ValueModelsRecommended:     "recommended defaults",
