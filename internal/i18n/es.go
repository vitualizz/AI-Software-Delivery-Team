...
var Spanish = Catalog{
	Installer: InstallerStrings{
		...
		OptionModelsRecommended:    "Usar modelos recomendados — cada paso trae un default razonable",
		OptionModelsCustomize:      "Personalizar por paso — elegí el modelo de cada paso de especialista",
		HintRunsAs:                 "→ corre como %s en Claude Code",
		LabelModels:                "Modelos:",
		ValueModelsRecommended:     "defaults recomendados",
